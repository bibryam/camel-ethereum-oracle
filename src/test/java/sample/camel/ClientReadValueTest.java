...
public class ClientReadValueTest extends CamelTestSupport {

    public ClientReadValueTest() {
        System.setProperty("org.apache.commons.logging.Log", "org.apache.commons.logging.impl.SimpleLog");
        System.setProperty("org.apache.commons.logging.simplelog.showdatetime", "true");
        System.setProperty("org.apache.commons.logging.simplelog.log.org.apache.http.wire", "DEBUG");
    }

    @Produce(uri = "web3j://http://127.0.0.1:7545?operation=ETH_CALL")
    protected ProducerTemplate template;

    @Test
    public void ethCallTest() throws Exception {
        Function function = new Function("getBTCCap", Arrays.asList(), Arrays.asList(new TypeReference<Uint>() {}));
